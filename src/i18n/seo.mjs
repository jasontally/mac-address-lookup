 ...
 *
 * The brand wordmark stays "MAC Address Lookup" in every locale.
 */
...
export const SEO = {
  ...
  es: {
    title: 'Buscador de direcciones MAC y OUI — MAC Address Lookup',
    description:
  ...
  fr: {
    title: 'Recherche d’adresse MAC et OUI — MAC Address Lookup',
    description:
  ...
  pt: {
    title: 'Buscador de endereços MAC e OUI — MAC Address Lookup',
    description:
  ...
  bn: {
    title: 'MAC ঠিকানা লুকআপ — MAC Address Lookup',
    description:
  ...
  mr: {
    title: 'MAC पत्ता लुकअप — MAC Address Lookup',
    description:
  ...
  ur: {
    title: 'MAC ایڈریس لوک اپ — MAC Address Lookup',
    description:
  ...
  gu: {
    title: 'MAC સરનામું લુકઅપ — MAC Address Lookup',
    description:
  ...
  pa: {
    title: 'MAC ਪਤਾ ਲੁੱਕਅੱਪ — MAC Address Lookup',
    description:
  ...
  ta: {
    title: 'MAC முகவரி தேடல் — MAC Address Lookup',
    description:
  ...
  te: {
    title: 'MAC చిరునామా శోధన — MAC Address Lookup',
    description:
  ...
  kn: {
    title: 'MAC ವಿಳಾಸ ಹುಡುಕಾಟ — MAC Address Lookup',
    description:
  ...
  ml: {
    title: 'MAC വിലാസം തിരച്ചിൽ — MAC Address Lookup',
    description:
  ...
  ru: {
    title: 'Поиск MAC-адресов — MAC Address Lookup',
    description:
  ...
  vi: {
    title: 'Tra cứu địa chỉ MAC — MAC Address Lookup',
    description:
  ...
  it: {
    title: 'Ricerca indirizzi MAC — MAC Address Lookup',
    description:
  ...
  ar: {
    title: 'البحث عن عناوين MAC — MAC Address Lookup',
    description:
  ...
  sw: {
    title: 'Utafutaji wa Anwani za MAC — MAC Address Lookup',
    description:
  ...
  id: {
    title: 'Pencarian Alamat MAC — MAC Address Lookup',
    description:
  ...
  ha: {
    title: 'Binciken Adiresoshin MAC — MAC Address Lookup',
    description:
  ...
  pl: {
    title: 'Wyszukiwanie adresów MAC — MAC Address Lookup',
    description:
  ...
  fa: {
    title: 'جستجوی آدرس MAC — MAC Address Lookup',
    description:
  ...
  uk: {
    title: 'Пошук MAC-адрес — MAC Address Lookup',
    description:
  ...
  nl: {
    title: 'MAC-adres zoeken — MAC Address Lookup',
    description:
